...
{
    public class HSL_Siemens_S7 : ICommunicatePLC
    {
        ...
        public HSL_Siemens_S7(string _IP, int _Port = 102, string heartAddress = "DB0.0")
        {
            Activate();
            IP = _IP;
            Port = _Port;
        ...
        private void start()
        {
            ...
            connect = (PLC as SiemensS7Net).ConnectServer();
        }
