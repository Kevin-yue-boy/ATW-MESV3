...
{
    public class BytesConverter_Keyence_MC: IBytesConverterPLC
    {
        ...
        {
            return System.BitConverter.ToUInt32(Buffer.Skip(Pos).Take(4).ToArray());
        }
        ...
        {
            return (Single)Math.Round(System.BitConverter.ToSingle(Buffer.Skip(Pos).Take(4).ToArray(), 0), 6);
        }
