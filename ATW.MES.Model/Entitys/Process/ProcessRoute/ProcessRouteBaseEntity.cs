...
namespace ATW.MES.Model.Entitys.Process.ProcessRoute
{
    [SugarTable("Process_ProcessRoute_Base")]
    [CacheStorage(EnableYN = true)]
    public class ProcessRouteBaseEntity
    {
        ...
        /// 工艺路线名称
        /// </summary>
        [SugarColumn(IsNullable = false, ColumnDescription = "工艺路线名称", Length = 200)]
        public string ProcessRouteName { get; set; }

        /// <summary>
        /// 工艺路线编码
        /// </summary>
        [SugarColumn(IsNullable = false, ColumnDescription = "工艺路线编码", Length = 200)]
