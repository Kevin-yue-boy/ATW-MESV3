...
{
    [SugarTable("Process_ProcessRoute")]
    ...
    public class ProcessRouteEntity
    {
        ...
        /// 工艺路线GUID
        /// </summary>
        [SugarColumn(IsNullable = false, ColumnDescription = "工艺路线GUID")]
        public Guid ProcessRouteGUID { get; set; }

        /// <summary>
        /// 基础工序GUID
        /// </summary>
        [SugarColumn(IsNullable = false, ColumnDescription = "基础工序GUID")]
