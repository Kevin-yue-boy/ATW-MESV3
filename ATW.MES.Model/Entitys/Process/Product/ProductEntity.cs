...
namespace ATW.MES.Model.Entitys.Process.Product
{
    [SugarTable("Process_Product")]
    ...
    public class ProductEntity
    {
        ...
        /// 产品名称
        /// </summary>
        [SugarColumn(IsNullable = false, ColumnDescription = "产品名称", Length = 200)]
        public string ProductName { get; set; }

        /// <summary>
        /// 产品编码
        /// </summary>
        [SugarColumn(IsNullable = false, ColumnDescription = "产品编码", Length = 200)]
