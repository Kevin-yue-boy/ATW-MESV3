...
{
    [SugarTable("Base_PLCInterfaceBase")]
    [CacheStorage(EnableYN = true)]
    public class BasePLCInterfaceBaseEntity
    {
        ...
        /// PLC接口名称
        /// </summary>
        [SugarColumn(IsNullable = false, ColumnDescription = "PLC接口名称", Length = 200)]
        public string PLCInterfaceName { get; set; }

        /// <summary>
        /// PLC接口编码
        /// </summary>
        [SugarColumn(IsNullable = false, ColumnDescription = "PLC接口编码", Length = 200)]
        public string PLCInterfaceCode { get; set; }
