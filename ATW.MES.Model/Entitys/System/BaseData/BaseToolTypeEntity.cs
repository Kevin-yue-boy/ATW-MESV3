...
{
    [SugarTable("Base_ToolType")]
    [CacheStorage(EnableYN = true)]
    public class BaseToolTypeEntity
    {
        ...
        /// 工作类型GUID
        /// </summary>
        [SugarColumn(IsNullable = false, ColumnDescription = "工作类型GUID", Length = 200)]
        public Guid WorkTypeGUID { get; set; }

        /// <summary>
        /// 工具类型名称
        /// </summary>
        [SugarColumn(IsNullable = false, ColumnDescription = "工具类型名称", Length = 200)]
        public string ToolTypeName { get; set; }

        /// <summary>
        /// 工具类型编码
        /// </summary>
        [SugarColumn(IsNullable = false, ColumnDescription = "工具类型编码", Length = 200)]
